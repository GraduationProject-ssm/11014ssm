...
public class XinwenfenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XinwenfenleiEntity xinwenfenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XinwenfenleiEntity xinwenfenlei, HttpServletRequest request){
        EntityWrapper<XinwenfenleiEntity> ew = new EntityWrapper<XinwenfenleiEntity>();
    	PageUtils page = xinwenfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xinwenfenlei), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
